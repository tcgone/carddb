...
public enum CardType {
  ...
  POKEMON_V(111, "Pokémon V", "pokemon-v"),
  VMAX(112, "Pokémon VMAX", "vmax"),
  G_SPEC(113, "G-SPEC", "g-spec"),
  DELTA(114, "Delta Species", "delta-species"),
  POKEMON_SP(115, "Pokémon SP", "pokemon-sp"),
  SINGLE_STRIKE(116, "Single Strike", "single-strike"),
  RAPID_STRIKE(117, "Rapid Strike", "rapid-strike"),
  VSTAR(118, "VSTAR", "vstar"),
  FUSION_STRIKE(119, "Fusion Strike", "fusion-strike"),
  V_UNION(120, "V-UNION", "v-union"),
  RADIANT(121, "Radiant", "radiant"),
